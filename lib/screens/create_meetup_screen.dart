  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      final newMeetup = Meetup(
        ...
        host: Provider.of<MockDataService>(context, listen: false).currentUser,
        participantIds: [
          Provider.of<MockDataService>(context, listen: false).currentUser.id,
        ],
        imageUrl:
            'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60', // Default image
      );

      Provider.of<MockDataService>(context, listen: false).addMeetup(newMeetup);
